...
public class MailContant {
    ...
    public static final String BODY_STARTS = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\"\n" +
            ...
            "                                                                                                    <span style=\"color: #e67e23; font-size: 26px; line-height: 36.4px; background-color: #ffffff;\">";

    public static final String BODY_BODY = "</span>\n" +
            "                                                                                                </p>\n" +
            "                                                                                            </div>\n" +
            "\n" +
            "                                                                                        </td>\n" +
            ...
            "                                                                                            align=\"left\">\n" +
            "                                                                                            <p style=\"font-size: 16px; line-height: 20.8px; font-family: Lato, sans-serif;\">";
    public static final String BODY_END = " </p>\n" +
            "                                                                                        </td>\n" +
            "                                                                                    </tr>\n" +
            "                                                                                    </tbody>\n" +
            "                                                                                </table>\n" +
